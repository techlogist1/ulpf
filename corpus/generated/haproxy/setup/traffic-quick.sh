#!/bin/sh
# QUICK variant of traffic.sh: identical logic, loop counts cut (500/300/80/60 -> 60/40/12/10)
# so the whole demo fits in under 5 minutes. Runs inside the "client" container.
