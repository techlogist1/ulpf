...
| ArcSight CEF | cef | *(landing in lane 3; strategy cef; synthetic from the specification)* | |
| IBM LEEF | leef | *(landing in lane 3; strategy leef; synthetic from the specification)* | |
| AWS CloudTrail | json | *(landing in lane 3; strategy json; synthetic from the specification)* | |
